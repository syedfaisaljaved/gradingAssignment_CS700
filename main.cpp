...
/**
 * @file vector
 * @brief header file called vectors are sequence containers representing arrays that can change in size.
 * */
#include <vector>
/**
 * @file grades_section1.h
 * @brief user-defined header file grades_section1.h to propagate declarations to code file.
 * */
#include "grades_section1.h"
/**
 * @file grades_section2.h
 * @brief user-defined header file grades_section2.h to propagate declarations to code file.
 * */
